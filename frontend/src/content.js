export const SOURCES = {
  wiki: { sup: 'W', label: 'Wikipedia', title: 'Tarakasi', url: 'https://en.wikipedia.org/wiki/Tarakasi', role: 'Process detail, alloy composition, motifs, Odissi ornament names, and the Chandi Medha history with dated installations.' },
  vikaspedia: { sup: 'VK', label: 'Vikaspedia / ASI', title: 'Cuttack Rupa Tarakasi: The Timeless Silver Filigree Art From the Silver City', url: 'https://en.vikaspedia.in/viewcontent/education/archaeological-survey-of-india/cuttack-rupa-tarakasi-the-timeless-silver-filigree-art-from-the-silver-city', role: "The 'exact origin is unclear' framing and the 12th-century reference; the most institutionally authoritative voice on the unresolved-origin question." },
  gac: { sup: 'GA', label: 'Google Arts & Culture / Dastkari Haat Samiti', title: 'Tarakasi: The Making of Silver Filigree', url: 'https://artsandculture.google.com/story/tarakasi-the-making-of-silver-filigree-dastkari-haat-samiti/1AVxVAl70Rj6LA', role: 'The step-by-step making process: silver bricks, wire-drawing, dies, workshop scale, finishing. Documented by Chirodeep Chaudhuri with artisan Ruksar Ali.' },
  virasat: { sup: 'VR', label: 'Virasat-E-Hind Foundation', title: 'Tarakasi Art: On the Brink of Survival', url: 'https://blogvirasatehind.wordpress.com/2017/08/18/tarakasi-art-on-the-brink-of-survival/', role: 'The Persia-via-Indonesia maritime origin theory, Mughal patronage, the Madhusudan Das and 1962 cooperative revival, the rose-motif labour detail, and the survival challenges.' },
  drishti: { sup: 'DR', label: 'Drishti IAS', title: 'GI Tag to Cuttack Rupa Tarakasi', url: 'https://www.drishtiias.com/daily-updates/daily-news-analysis/gi-tag-to-cuttack-rupa-tarakasi', role: 'The GI recognition date, the legal explainer (DPIIT, GI Act 1999, TRIPS), and the ancient Mesopotamian filigree lineage.' },
  oaklores: { sup: 'OL', label: 'Oak Lores', title: "Tales in Twisted Silver: A Tribute to Odisha's Filigree Craft", url: 'https://oaklores.com/2025/04/23/tales-in-twisted-silver-a-tribute-to-odishas-filigree-craft/', role: "The Bhoi-dynasty dating, the 'Silver City' epithet, Bali Yatra, named market neighbourhoods, and contemporary revival notes." },
  orissapost: { sup: 'OP', label: 'OrissaPOST', title: 'Fading Sparkle', url: 'https://www.orissapost.com/fading-sparkle/', role: 'Committee-by-committee record of chandi medha installations across Cuttack, including Khan Nagar, Ganga Mandir and Bapuji Club, and the count of backdrops city-wide.' },
  obytes1: { sup: 'B1', label: 'OdishaBytes', title: "Two New Entrants To Elite 'Chandi Medhas' Club Of Odisha's Cuttack", url: 'https://odishabytes.com/durga-puja-two-new-entrants-to-elite-chandi-medhas-club-of-odishas-cuttack/', role: 'Jobra and Maa Mangala Puja Committee entering the chandi medha club, with weight, dimensions and cost detail.' },
  obytes2: { sup: 'B2', label: 'OdishaBytes', title: "Four More 'Chandi Medha' For Durga Puja In Odisha's Cuttack", url: 'https://odishabytes.com/four-more-chandi-medha-for-durga-puja-in-odishas-cuttack/', role: 'Kafla Bazaar, Mohamadia Bazaar, Nima Sahi and Nimchouri joining the chandi medha club, with weight and dimension detail.' },
};
