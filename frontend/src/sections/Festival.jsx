            ...
            <div className="lg:col-span-7">
              <Reveal>
                <div className="relative">
                  <Ph label="PANORAMA: Chandi Medha backdrop framing the idol" meta="Photograph to be supplied, wide, festival light, drag-zoom intended" ratio="aspect-[21/10]" src="/images/festival-chandi-medha-panorama.webp" alt="Chandi Medha silver backdrop framing the Durga idol" />
                  <div className="relative z-10 -mt-10 ml-auto w-2/5 border-4 border-paper2 md:-mt-16">
                    <Ph label="MACRO: one motif of the same backdrop" meta="The scale contrast, in one frame" ratio="aspect-square" src="/images/festival-chandi-medha-detail.webp" alt="Macro detail of the Chandi Medha silver backdrop wirework" />
                  </div>
                </div>
              </Reveal>
            </div>
      ...
      <section id="cuttack" className="mx-auto max-w-[1440px] px-5 py-16 md:px-10 md:py-28" data-testid="section-cuttack">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 lg:col-start-7 lg:pt-24">
            <Reveal>
              <Ph label="CITY: Cuttack market lane, silver shops" meta="Photograph to be supplied, early morning, directional light" ratio="aspect-[4/3]" src="/images/cuttack-market-lane.webp" alt="Cuttack silver-market lane lined with Tarakasi jewellers" />
            </Reveal>
          </div>
        </div>
      </section>
